...
if __name__ == "__main__":
    ...
    observer.start()
    app.run(host='127.0.0.1', port=5002, debug=True, ssl_context=(os.path.join(os.path.dirname(__file__), 'keys', 'cert.pem'), os.path.join(os.path.dirname(__file__), 'keys', 'key.pem')))